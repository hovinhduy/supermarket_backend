...
public record OrderInfo(
                 ...
                 * Mã đơn hàng
                 */
                @JsonProperty(required = true, value = "order_code") String orderCode,
                 ...
                 * Ngày đặt hàng
                 */
                @JsonProperty(value = "order_date") LocalDateTime orderDate,

                /**
                 * Ngày giao hàng dự kiến
                 */
                @JsonProperty(value = "estimated_delivery") LocalDateTime estimatedDelivery,

                /**
                 * Phương thức giao hàng
                 */
                @JsonProperty(value = "delivery_method") String deliveryMethod,

                /**
                 * Địa chỉ giao hàng
                 */
                @JsonProperty(value = "delivery_address") String deliveryAddress,
                /**
                 * Số lượng sản phẩm trong đơn
                 */
                @JsonProperty(value = "item_count") Integer itemCount,

                /**
                 * Danh sách sản phẩm trong đơn (tóm tắt)
                 */
                @JsonProperty(value = "items") List<OrderItemInfo> items) {
