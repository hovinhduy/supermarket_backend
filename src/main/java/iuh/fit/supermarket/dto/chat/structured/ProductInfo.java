...
public record ProductInfo(
                 ...
                 */
                @JsonProperty(value = "product_unit_id", required = true) Long productUnitId,
                 ...
                 * Tình trạng tồn kho
                 */
                @JsonProperty(value = "stock_status") String stockStatus,
                 ...
                 */
                @JsonProperty(value = "has_promotion") Boolean hasPromotion,

                /**
                 * Giá sau khuyến mãi (nếu có)
                 */
                @JsonProperty(value = "promotion_price") BigDecimal promotionPrice) {
}
