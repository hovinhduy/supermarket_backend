...
/**
 * DTO cho yêu cầu tạo mới thương hiệu
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Yêu cầu tạo mới thương hiệu")
public class BrandCreateRequest {
    ...
    @Schema(description = "Tên thương hiệu", example = "Samsung", required = true)
    private String name;

    /**
     * Mã thương hiệu (tùy chọn, sẽ tự động tạo nếu không cung cấp)
     */
