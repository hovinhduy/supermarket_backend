...
/**
 * DTO cho yêu cầu tạo mới nhà cung cấp
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class SupplierCreateRequest {
    ...
    /**
     * Mã nhà cung cấp (tùy chọn, sẽ tự động tạo nếu không cung cấp)
     */
     ...
     */
    @Schema(description = "Trạng thái hoạt động", example = "true", defaultValue = "true")
