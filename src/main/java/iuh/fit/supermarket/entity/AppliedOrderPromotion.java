...
/**
 * Entity lưu thông tin khuyến mãi áp dụng cho toàn đơn hàng (ORDER_DISCOUNT)
 */
@Entity
@Table(name = "applied_order_promotions")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AppliedOrderPromotion {
    ...
    @Column(name = "applied_order_promotion_id")
    private Long appliedOrderPromotionId;
    ...
    /**
     * Hóa đơn áp dụng khuyến mãi này
     */
