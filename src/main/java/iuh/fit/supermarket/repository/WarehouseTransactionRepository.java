...
public interface WarehouseTransactionRepository extends JpaRepository<WarehouseTransaction, Long> {
    ...
    List<WarehouseTransaction> findByTransactionType(@Param("transactionType") WarehouseTransaction.TransactionType transactionType);
     ...
     */
    @Query("SELECT wt FROM WarehouseTransaction wt WHERE wt.transactionType = :transactionType ORDER BY wt.transactionDate DESC")
    Page<WarehouseTransaction> findByTransactionType(@Param("transactionType") WarehouseTransaction.TransactionType transactionType, Pageable pageable);
     ...
     */
    @Query("SELECT wt FROM WarehouseTransaction wt WHERE wt.transactionDate BETWEEN :startDate AND :endDate ORDER BY wt.transactionDate DESC")
    Page<WarehouseTransaction> findByDateRange(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate, Pageable pageable);
    ...
    List<WarehouseTransaction> findByVariantIdAndTransactionType(@Param("variantId") Long variantId, @Param("transactionType") WarehouseTransaction.TransactionType transactionType);
    ...
    List<WarehouseTransaction> findByVariantIdAndDateRange(@Param("variantId") Long variantId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    Integer sumQuantityChangeByVariantIdAndTransactionType(@Param("variantId") Long variantId, @Param("transactionType") WarehouseTransaction.TransactionType transactionType);
